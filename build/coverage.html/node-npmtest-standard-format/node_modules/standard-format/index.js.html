...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-standard-format/node_modules/standard-format/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    <h1 style="font-weight: bold;">
        <a href="https://github.com/npmtest/node-npmtest-standard-format">npmtest-standard-format (v0.0.1)</a>
    </h1>
    <h1>Code coverage report for <span class="entity">node-npmtest-standard-format/node_modules/standard-format/index.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90% <small>(27 / 30)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-standard-format/node_modules/standard-format/</a> &#187; index.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var deglob = require('deglob')
var fs = require('fs')
...
module.exports.load = function (opts, cb) {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (typeof opts === 'function') {
    cb = opts
    opts = {}
  }
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (opts.ignore) <span class="cstat-no" title="statement not covered" >ignore = ignore.concat(opts.ignore)</span>
&nbsp;
  var deglobOpts = {
    ignore: ignore,
...
<div class="footer">
    <div class="meta">Generated by <a href="https://github.com/kaizhu256/node-utility2" target="_blank">utility2</a> at Tue Apr 25 2017 20:51:39 GMT+0000 (UTC)</div>
</div>
</body>
</html>
